...
@app.route("/spolify", methods=['GET', 'POST'])
def login():
    msg = ''
...
# http://localhost:5000/spolify/logout - this will be the logout page
@app.route('/spolify/logout')
def logout():
...
# http://localhost:5000/spolify/register - this will be the registration page, we need to use both GET and POST requests
@app.route('/spolify/register', methods=['GET', 'POST'])
def register():
...
# http://localhost:5000/spolify/home - this will be the home page, only accessible for loggedin users
@app.route('/spolify/home')
def home():
...
# http://localhost:5000/spolify/profile - this will be the profile page, only accessible for loggedin users
@app.route('/spolify/profile')
def profile():
    # Check if user is loggedin
    if 'loggedin' in session:
...
# http://localhost:5000/spolify/allsongs - this will show all songs, only accessible for loggedin users
@app.route('/spolify/allsongs')
def allsongs():
    # Check if user is loggedin
    if 'loggedin' in session:
...
@app.route('/spolify/add_to_fav', methods=['GET', 'POST'])
...
@app.route('/spolify/favourite_songs')
...
@app.route('/spolify/remove_favourite_songs', methods=['GET', 'POST'])
...
@app.route('/spolify/remove_friends', methods=['GET', 'POST'])
...
@app.route('/spolify/msg_friends', methods=['GET', 'POST'])
...
@app.route('/spolify/send_msg_friend', methods=['GET', 'POST'])
...
@app.route('/spolify/msg_group', methods=['GET', 'POST'])
...
@app.route('/spolify/send_msg_group', methods=['GET', 'POST'])
...
@app.route('/spolify/exit_group', methods=['GET', 'POST'])
...
@app.route('/spolify/search_songs', methods=['GET', 'POST'])
...
@app.route('/spolify/add_search_song', methods=['GET', 'POST'])
...
@app.route('/spolify/search_friends', methods=['GET', 'POST'])
...
@app.route('/spolify/add_search_friend', methods=['GET', 'POST'])
...
@app.route('/spolify/search_groups', methods=['GET', 'POST'])
...
@app.route('/spolify/add_search_group', methods=['GET', 'POST'])
...
@app.route('/spolify/goto_create_roup', methods=['GET', 'POST'])
def goto_create_group():    # function to render createGroup.html page
    return render_template('createGroup.html')


@app.route('/spolify/create_group', methods=['GET', 'POST'])
...
@app.route('/spolify/remove_msg', methods=['GET', 'POST'])
...
@app.route('/spolify/update_form', methods=['GET', 'POST'])
def update_form():  # function to render updateProfile.html page
    return render_template('updateProfile.html')


@app.route('/spolify/update', methods=['GET', 'POST'])
...
@app.route('/spolify/generate_report', methods=['GET', 'POST'])
